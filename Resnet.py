...
training_dir = os.path.join(dataset_dir, 'TrainVal')
...
ResNet_model = tf.keras.applications.ResNet152V2(weights=None, include_top=False, input_shape=(img_h, img_w, 3))
...
mcp_save = ModelCheckpoint(modelname+'.hdf5', save_best_only=True, monitor='val_loss', mode='min')	
callbacks = [lrr, mcp_save]
